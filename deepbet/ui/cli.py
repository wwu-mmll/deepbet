...
def run_cli():
    ...
    parser.add_argument('-g', '--no_gpu', help='If GPU should be avoided', required=False, type=bool,
                        default=False, action=argparse.BooleanOptionalAction)
    parser.add_argument('-s', '--skip_broken', help='If broken files should be skipped', required=False, type=bool,
